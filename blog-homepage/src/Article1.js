...
const article1 = missedArticles
console.log(article1)
const dateformat= require('dateformat');
const date= 'article.postedDate'
console.log(dateformat(date, 'mmm ds'))
class Article1 extends React.Component{
    static propTypes={
     post:PropTypes.arrayOf(PropTypes.string) 
     }
    render(){
        const date = article1.postedDate;
        console.log(date)
        return(
            <div class ='content-title'>
                <h3><em>In case you missed it</em></h3>
            <div class='article1-holder'>
                {article1.map((post, id)=> {
                    return(
                                    ...
                                    <div class='card-content-data-holder'>
                                        <div  class='card-content-data-inner'>
                                            <img src={post.author.image}class='card-author-image'/>
                                                <div key={post.id} class='content-author'>
                                                    ...
                                                    <p>
                                                        {post.hasAudioAvailable}
                                                    </p>
                                                    <p>
                                                        {post.memberPreview}
                                                    </p>
                                                </div>
                                                <div key={post.id} class='card-content-button'>
                                                    <a href=''>
                                                        <svg with='25' height='25' viewBox="0 0 841.9 595.3">
